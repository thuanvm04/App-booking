                        ...
                        <tbody>
                                ...
                                <td>
                                    <div class="customer d-flex align-items-center">
                                        <div class="thumb_34 mr_15 mt-0"><img
                                                class="img-fluid radius_50" src="{{ asset('themes/admin/img/customers/1.png')}}"
                                                alt></div>
                            ...
                            <tr>
                                <td>
                                    <div class="customer d-flex align-items-center">
                                        <div class="thumb_34 mr_15 mt-0"><img
                                                class="img-fluid radius_50" src="{{ asset('themes/admin/img/customers/2.png')}}"
                                                alt></div>
                                        <span class="f_s_14 f_w_400 color_text_1">Customer</span>
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <div class="customer d-flex align-items-center">
                                        <div class="thumb_34 mr_15 mt-0"><img
                                                class="img-fluid radius_50" src="{{ asset('themes/admin/img/customers/3.png')}}"
                                                alt></div>
                                        <span class="f_s_14 f_w_400 color_text_1">Customer</span>
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <div class="customer d-flex align-items-center">
                                        <div class="thumb_34 mr_15 mt-0"><img
                                                class="img-fluid radius_50" src="{{ asset('themes/admin/img/customers/4.png')}}"
                                                alt></div>
                                        <span class="f_s_14 f_w_400 color_text_1">Customer</span>
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <div class="customer d-flex align-items-center">
                                        <div class="thumb_34 mr_15 mt-0"><img
                                                class="img-fluid radius_50" src="{{ asset('themes/admin/img/customers/5.png')}}"
                                                alt></div>
                                        <span class="f_s_14 f_w_400 color_text_1">Customer</span>
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <div class="customer d-flex align-items-center">
                                        <div class="thumb_34 mr_15 mt-0"><img
                                                class="img-fluid radius_50" src="{{ asset('themes/admin/img/customers/6.png')}}"
                                                alt></div>
                                        <span class="f_s_14 f_w_400 color_text_1">Customer</span>
                                    </div>
                                </td>
                    ...
                    <table class="table lms_table_active2 p-0">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="f_s_14 f_w_400 text-end"><a href="#"
                                        class="badge_btn_1">354 sold</a></td>
                            </tr>
                            <tr>
                                <td>
                                    <div class="customer d-flex align-items-center">
                                        <div class="thumb_62 mr_15 mt-0"><img
                                                class="img-fluid radius_50"
                                                src="{{ asset('themes/admin/img/customers/pro_big_1.png')}}" alt></div>
                            ...
                            <tr>
                                <td>
                                    <div class="customer d-flex align-items-center">
                                        <div class="thumb_62 mr_15 mt-0"><img
                                                class="img-fluid radius_50"
                                                src="{{ asset('themes/admin/img/customers/pro_big_2.png')}}" alt></div>
