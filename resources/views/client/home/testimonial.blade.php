                                            ...
                                            <div class="lh-testimonials-contain">
                                                <div class="d-flex">
                                                    <div class="lh-testimonials-inner">
                                                        <img src="{{asset('themes/client/assets/img/businessman/businessman-1.jpg')}}"
                                                    ...
                                                    <div class="lh-testimonials-side-image">
                                                        <img src="{{asset('themes/client/assets/img/testimonials/quotes.svg')}}"
                                    ...
                                    <div class="lh-testimonials">
                                        <div class="row">
                                            <div class="lh-testimonials-contain">
                                                <div class="d-flex">
                                                    <div class="lh-testimonials-inner">
                                                        <img src="{{asset('themes/client/assets/img/businessman/businessman-2.jpg')}}"
                                                            alt="businessman" class="businessman">
                                                        <div class="lh-testimonials-name-detalis">
                                                            <h5>John Doe</h5>
                                                            <span>Bristol, Uk</span>
                                    ...
                                    <div class="lh-testimonials">
                                        <div class="row">
                                            <div class="lh-testimonials-contain">
                                                <div class="d-flex">
                                                    <div class="lh-testimonials-inner">
                                                        <img src="{{asset('themes/client/assets/img/businessman/businessman-3.jpg')}}"
                                                            alt="businessman" class="businessman">
                                                        <div class="lh-testimonials-name-detalis">
                                                            <h5>Moris Selemen</h5>
                                                            <span>Bristol, Uk</span>
